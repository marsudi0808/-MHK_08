...
cl = LineClient(authToken='EvkIlbRkLYKKdxEzxxE2.judyzdUH7VmsfDiUleBNGG./lbSjobOOQVkhJX1vS+XyQZBwQa3s1s9h7iankoOiVE=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LineClient(authToken='EwKnwzMhpWNT647GmzX1.F0ABpLeoRsEKFrgjk8Jvaq.rj5Jkf9rag0n5+evhQ10wJiCQbGr/6AHC3FYV/EwAN0=')
...
#km = LineClient(authToken='EvHZO9MGP4QLtjbxmmn1.F0ABpLeoRsEKFrgjk8Jvaq.yl+pwBExpaa4G97wS2Vap7Nc6yApto8VPC1qSFA+E2I=')
#km.log("Auth Token : " + str(km.authToken))
#channel4 = LineChannel(km)
#km.log("Channel Access Token : " + str(channel4.channelAccessToken))

sw = LineClient(authToken='Ewe2EjryWlKF0VTFbhQ0.oy7rSoL9QI2iYnoc1syTya.ZacWMbXyNQig7+nlvILYrCTDr6rHhKDcJjBWHPdZr20=')
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"Creator Bot MARSUDI") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
